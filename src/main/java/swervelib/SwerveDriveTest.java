...
public class SwerveDriveTest {
  ...
  private static final MutableMeasure<Velocity<Distance>> m_velocity =
  ...
  private static final MutableMeasure<Velocity<Angle>> m_angVelocity =
      mutable(DegreesPerSecond.of(0));
  ...
  public static double findCouplingRatio(SwerveDrive swerveDrive, double volts, boolean automatic) {
    ...
    for (SwerveModule module : swerveDrive.getModules()) {
      ...
      double driveEncoderPositionRotations =
          module.getDriveMotor().getPosition() / module.configuration.conversionFactors.drive;
      if (automatic) {
